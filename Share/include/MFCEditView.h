#if !defined(AFX_MFCEDITVIEW_H__7C200AA0_5BE4_4C72_B0CF_2A5C51D18712__INCLUDED_)
#define AFX_MFCEDITVIEW_H__7C200AA0_5BE4_4C72_B0CF_2A5C51D18712__INCLUDED_
...
class CMFCEditFindDlg : public CFindReplaceDialog
{
friend class CMFCEditView;

	virtual ~CMFCEditFindDlg ();

protected:
	CMFCEditView* m_pParent;
};

/////////////////////////////////////////////////////////////////////////////
// CMFCEditView view

class CMFCEditView : public CView
{
	friend class CMFCEditFindDlg;

protected:
	DECLARE_DYNCREATE(CMFCEditView)
	CMFCEditView();           // protected constructor used by dynamic creation

// Attributes
public:
	CMFCEditCtrl* GetEditCtrl () const
	{
...
protected:
	CMFCEditCtrl*		m_pWndEditCtrl;
	CMFCEditFindDlg*	m_pFindDlg;
...
protected:
	...
	virtual CMFCEditCtrl* CreateEdit ();

	// Generated message map functions
protected:
	//{{AFX_MSG(CMFCEditView)
...
#endif // !defined(AFX_MFCEDITVIEW_H__7C200AA0_5BE4_4C72_B0CF_2A5C51D18712__INCLUDED_)
