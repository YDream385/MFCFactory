...
//*******************************************************************************
//
// MFCOutlineParser.h: interface for the CMFCOutlineParser class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_MFCOUTLINEPARSER_H__042FF594_A696_4902_A475_119896175319__INCLUDED_)
#define AFX_MFCOUTLINEPARSER_H__042FF594_A696_4902_A475_119896175319__INCLUDED_
...
class CMFCOutlineBaseNode;
class CMFCOutlineNode;
struct MFC_EDIT_OUTLINE_CHANGES;

class CMFCOutlineParser : public CObject 
{
public:
	CMFCOutlineParser();
	virtual ~CMFCOutlineParser();

	virtual void UpdateOutlining (CString& strBuffer, int nOffsetFrom, int nCharsCount,
								  CMFCOutlineNode* pOutlineNode, MFC_EDIT_OUTLINE_CHANGES& changes);
	virtual void Init ();
...
protected:
	...
	virtual BOOL AddMarker (CMFCOutlineNode* pMarkerBlock, CMFCOutlineNode* pParentNode,
							MFC_EDIT_OUTLINE_CHANGES& changes) const;
	virtual CMFCOutlineNode* FindFittingBlock (CMFCOutlineNode* pBlock, CMFCOutlineNode* pStartFrom) const;

	virtual CMFCOutlineNode* GetRangeToReparse (CMFCOutlineNode* pOutlineNode,
												int& nStartOffset, int& nEndOffset) const;
	

	inline CMFCOutlineNode* AddNode (CMFCOutlineNode* pNewNode, CMFCOutlineNode* pParentNode, MFC_EDIT_OUTLINE_CHANGES& changes) const;
	inline CMFCOutlineNode* RemoveNode (CMFCOutlineNode* pNode, CMFCOutlineNode* pParentNode, MFC_EDIT_OUTLINE_CHANGES& changes,
...
#endif // !defined(AFX_MFCOUTLINEPARSER_H__042FF594_A696_4902_A475_119896175319__INCLUDED_)
